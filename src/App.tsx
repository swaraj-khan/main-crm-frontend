    ...
    <div style={{ fontFamily: 'sans-serif', minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f9fafb' }}>
      <header style={{ 
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          </Link>          <Link to="/my-dashboard" style={{ textDecoration: "none" }}>
            <button style={getButtonStyle("/my-dashboard")}>
              My Dashboard
            </button>
          </Link>          <Link to="/crm/user-level" style={{ textDecoration: 'none' }}>
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/my-dashboard" element={<PrivateRoute><Layout><MyDashboard /></Layout></PrivateRoute>} />
